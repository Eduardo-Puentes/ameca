...
Este proyecto usa [`next/font`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) para optimizar y cargar [Geist](https://vercel.com/font), una nueva familia tipográfica de Vercel.

## Aprender más

Para aprender más sobre Next.js, revisa estos recursos:

- [Documentación de Next.js](https://nextjs.org/docs) - funciones y API de Next.js.
- [Aprende Next.js](https://nextjs.org/learn) - tutorial interactivo de Next.js.

También puedes ver el [repositorio de Next.js en GitHub](https://github.com/vercel/next.js). ¡Tus comentarios y contribuciones son bienvenidos!
