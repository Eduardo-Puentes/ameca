...
export const approveMemberRequestPayment = pick(api.approveMemberRequestPayment);
...
export const approveEventRequestPayment = pick(api.approveEventRequestPayment);
