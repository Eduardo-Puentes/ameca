...
export const draCelesteCIbarraHerrera: BoardMember = {
  id: 2,
...
export const draMonicaLChavezGonzalez: BoardMember = {
  id: 3,
  slug: "dra-monica-l-chavez-gonzalez",
  name: "Dra. Mónica L. Chávez González",
  role: "Secretaria",
  term: "2025-2027",
  organization: "UAdeC",
  photo: "/3.png",
...
export const draEstherPerezCarrillo: BoardMember = {
  id: 4,
  slug: "dra-esther-perez-carrillo",
  name: "Dra. Esther Pérez Carrillo",
  role: "Tesorera",
  term: "2025-2027",
  organization: "ITESM",
  photo: "/4.png",
...
export const drHectorECortesFerre: BoardMember = {
  id: 5,
  slug: "dr-hector-e-cortes-ferre",
...
export const drEverardoMaresMares: BoardMember = {
  id: 7,
...
export const ingJuanCarlosElizaldeLeon: BoardMember = {
  id: 8,
  slug: "ing-juan-carlos-elizalde-leon",
...
export const mbMariaAzucenaRochaMendoza: BoardMember = {
  id: 9,
...
export const ibtMarioPenaAlvarado: BoardMember = {
  id: 10,
...
export const boardMembers: BoardMember[] = [
  drCesarOzunaLopez,
  draCelesteCIbarraHerrera,
  draMonicaLChavezGonzalez,
  draEstherPerezCarrillo,
  drHectorECortesFerre,
  drJonatanJafetUuhNarvaez,
  drEverardoMaresMares,
  ingJuanCarlosElizaldeLeon,
  mbMariaAzucenaRochaMendoza,
  ibtMarioPenaAlvarado,
];
